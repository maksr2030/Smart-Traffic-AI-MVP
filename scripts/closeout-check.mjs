...
for(const contract of ['mvpCloseoutRoom','Run local performance baseline','runFailureInjectionSuite','productionReadiness','physicalIPhoneValidated=false'])if(!runtime.includes(contract))throw new Error(`Closeout runtime contract missing: ${contract}`);
