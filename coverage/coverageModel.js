const IMPLEMENTED = new Set([
  ...
  'QTOS-02','QTOS-03','QTOS-04','QTOS-05','QTOS-08','QTOS-15','QTOS-17','QTOS-21','QTOS-22',
  'QCS-80','QCS-85','QCS-86','QCS-87','QCS-88','QCS-92','QCS-101'
]);

const REPRESENTED = new Set([
  '4','5','6','202','215','232','CR-05','CR-15','CR-17',
  'QTOS-18','QTOS-23','QTOS-25',
  'QCS-93','QCS-94','QCS-95','QCS-103','QCS-104'
]);

const MODULES = new Map([
  ['1','predictive-risk-baseline'],['2','routing'],['7','analytics-export'],['10','signals'],['200','signals'],['201','emergency-dispatch'],
  ['203','routing'],['209','signals'],['211','multi-incident'],['213','network-metrics'],['217','routing'],['218','signals'],['228','emergency-dispatch'],
  ['CR-14','network-metrics'],['CR-16','operations-engine'],['CR-18','dynamic-risk-digital-twin'],['CR-22','analytics-export'],
  ['QTOS-02','dynamic-risk-digital-twin'],['QTOS-03','predictive-risk-baseline'],['QTOS-04','routing'],['QTOS-05','predictive-network-load-orchestration'],['QTOS-08','signals'],['QTOS-15','multi-incident'],['QTOS-17','graph-engine'],['QTOS-21','predictive-autonomous-recommendation'],['QTOS-22','multi-horizon-candidate-orchestration'],
  ...
  ['CR-05','incident-input'],['CR-15','scenario-analysis'],['CR-17','connected-vehicle-design'],
  ...
  ['QCS-93','v2x-proxy-broadcast'],['QCS-94','hidden-hazard-input'],['QCS-95','adaptive-response-recommendation'],['QCS-101','dynamic-twin-risk-routing-and-command-plan'],['QCS-103','weather-response-proxy'],['QCS-104','network-integration-design']
]);
